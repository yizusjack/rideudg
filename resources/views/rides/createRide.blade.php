        ...
        <div class="card-body">
          ...
          <form action="{{route('ride.store')}}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="date_t" name="date_t" value="{{old('date_t')}}">
                  @error('date_t')
                    <p>{{$message}}</p>
                  @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="time" class="form-control" id="hour_t" name="hour_t" value="{{old('hour_t')}}">
                  @error('hour_t')
                    <p>{{$message}}</p>
                  @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="passengers_t" name="passengers_t" value="{{old('passengers_t')}}">
                  @error('passengers_t')
                    <p>{{$message}}</p>
                  @enderror
                </div>
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="places_id" name="places_id">
                      @foreach ($places as $place)
                          <option value="{{$place->id}}" @if(old('places_id') == $place->id)
                            selected 
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="destiny_id" name="destiny_id">
                      @foreach ($places as $place)
                          <option value="{{$place->id}}" @if(old('destiny_id') == $place->id)
                            selected 
                           @endif>{{$place->name_p}}</option>
                      @endforeach
                  </select>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="cars_id" name="cars_id">
                      @foreach ($cars as $car)
                          <option value="{{$car->id}}" @if(old('cars_id') == $car->id)
                            selected 
